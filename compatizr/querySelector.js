;(function() {
	...
	/*
	 * IE6-8 query selector implementation.
	 * 1. IE8 supports both functions but the selector engine is limited to CSS 2.1 selectors only.
	 * Altering window.Element.prototype allows IE8 to provide full CSS 3 selectors support.
	 * 2. IE6 and IE7 do not support prototyping on DOM elements. Fortunately, there is a workaround:
	 * A behavior can be used. 
	 */ 
	
	document.querySelector = window.Element.prototype.querySelector = function (path) {
		return Slick.find (this, path);
	}
	document.querySelectorAll = window.Element.prototype.querySelectorAll = function (path) {
		return Slick.search (this, path);
	}
	...
	;(function(){
		...
		local.search = function(context, expression, append, first){
			...
			if (typeof expression == 'string'){ // expression is a string
				...
				//marian:parsed = this.Slick.parse(expression);
		...
		local.matchNode = function(node, selector){
			...
			//marian: var parsed = this.Slick.parse(selector);
